...
async function renderCRM(el){
  ...
  try{
    ...
    var h='<div class="v1686-page v1686-crm"><header class="v1686-pagehead"><div><small>MODEL TOOLS · INDUSTRY RELATIONS</small><h1>Companies / Clients & Professional Contacts</h1><p>Search, filter and manage every client, casting and professional relationship.</p></div><div><button class="v1686-btn" onclick="window.CavyreCRM&&window.CavyreCRM.openCompany&&window.CavyreCRM.openCompany()">+ Company</button><button class="v1686-btn gold" onclick="window.CavyreCRM&&window.CavyreCRM.openContact&&window.CavyreCRM.openContact()">+ Contact</button></div></header>';
