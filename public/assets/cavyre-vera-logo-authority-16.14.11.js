(function(){
'use strict';
if(window.__CAVYRE_VERA_IDENTITY_AUTHORITY_161410__)return;window.__CAVYRE_VERA_IDENTITY_AUTHORITY_161410__=true;
...
function own(el){if(!el)return;el.setAttribute('data-vera-identity-authority','16.14.10');el.querySelectorAll('.vx20-vera-wave-mark,.vera-mark-img,.vera-avatar-img,.cvy-vera-canonical').forEach(function(n){n.remove();});if(!el.querySelector(':scope > .cvy-vera-native'))el.insertAdjacentHTML('afterbegin',SVG);}
...
window.CAVYRE_VERA_IDENTITY={version:'16.14.10',refresh:install};
})();
