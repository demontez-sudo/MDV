...
document.addEventListener('click',function(e){
 ...
 // Create Package is owned by the package desk button itself. Do not intercept here;
 // the previous delegated handler fired after the inline handler and opened a second legacy modal.
 if(/^\+?\s*(new|create)\s+(model\s+)?package$/.test(t)||/^create package$/.test(t)){ return; }
