...
;/* BEGIN cavyre-calendar-system-reset-16.11.15.js */
(function(){
'use strict';
...
function run(){
 /* 16.11.77: legacy Month/Week geometry disabled; Calendar Authority owns layout. */
 var b=document.getElementById('cavyre-release-badge-161075');
 document.documentElement.setAttribute('data-cavyre-feature-161115','active');
}
...
;/* END cavyre-calendar-system-reset-16.11.15.js */

;/* BEGIN cavyre-live-calendar-dom-authority-16.11.16.js */
(function(){
'use strict';
...
function run(){
  /* 16.11.77: preserve industry + command only; Month/Week/side intelligence owned by final Calendar Authority. */
  industry(); command();
  var b=document.getElementById('cavyre-release-badge-161075');
  
  document.documentElement.setAttribute('data-cavyre-feature-161116','active');
}
...
;/* END cavyre-live-calendar-dom-authority-16.11.16.js */
...
;/* BEGIN cavyre-deploy1-ux-calendar-cert-16.11.19.js */
(function(){
'use strict';
...
function certify(){
 ...
 var b=document.getElementById('cavyre-release-badge-161075');
 document.documentElement.setAttribute('data-cavyre-feature-161119','active');
}
...
;/* END cavyre-deploy1-ux-calendar-cert-16.11.19.js */

;/* BEGIN cavyre-deploy2-workflow-cert-16.11.20.js */
(function(){
'use strict';
...
function bind(){
 ...
 var b=document.getElementById('cavyre-release-badge-161075');
 document.documentElement.setAttribute('data-cavyre-feature-161120','active');
}
...
;/* END cavyre-deploy2-workflow-cert-16.11.20.js */

;/* BEGIN cavyre-deploy3-intelligence-data-cert-16.11.21.js */
(function(){
'use strict';
...
function bind(){
 ...
 var b=document.getElementById('cavyre-release-badge-161075');
 document.documentElement.setAttribute('data-cavyre-feature-161121','active');
}
var q=0;function go(){if(q)return;q=1;requestAnimationFrame(function(){q=0;bind()})}
document.readyState==='loading'?document.addEventListener('DOMContentLoaded',go,{once:true}):go();
new MutationObserver(go).observe(document.documentElement,{childList:true,subtree:true});
...
;/* END cavyre-deploy3-intelligence-data-cert-16.11.21.js */

;/* BEGIN cavyre-production-certification-16.11.22.js */
(function(){
'use strict';
...
function I(e,p,v){if(e)e.style.setProperty(p,v,'important')}
function mark(){
 document.documentElement.setAttribute('data-cavyre-feature-161122','active');
...
;/* END cavyre-production-certification-16.11.22.js */

;/* BEGIN cavyre-acceptance-repair-16.11.23.js */
(function(){
'use strict';
...
function run(){
 ...
 var b=document.getElementById('cavyre-release-badge-161075');
 document.documentElement.setAttribute('data-cavyre-feature-161123','active');
}
var q=0;function go(){if(q)return;q=1;requestAnimationFrame(function(){q=0;run()})}
document.readyState==='loading'?document.addEventListener('DOMContentLoaded',go,{once:true}):go();
new MutationObserver(go).observe(document.documentElement,{childList:true,subtree:true});
...
;/* END cavyre-acceptance-repair-16.11.23.js */
...
;/* BEGIN cavyre-month-split-intelligence-16.11.26.js */
(function(){
'use strict';
...
function sync(){
 ...
 document.documentElement.setAttribute('data-cavyre-feature-161126','active');
}
...
;/* END cavyre-month-split-intelligence-16.11.26.js */

;/* BEGIN cavyre-month-split-authority-16.11.27.js */
(function(){
'use strict';
...
function apply(){
 ...
 document.documentElement.setAttribute('data-cavyre-feature-161127','active');
}
...
;/* END cavyre-month-split-authority-16.11.27.js */
...
;/* BEGIN cavyre-calendar-geometry-runtime-16.11.40.js */
(function(){'use strict';if(window.__CAVYRE_CAL_GEOMETRY_161140__)return;window.__CAVYRE_CAL_GEOMETRY_161140__=1;
function apply(){var root=document.querySelector('#p-calendar .vx95-timeline');if(!root)return;var first=root.querySelector('.vx95-hours span'),startHour=6;if(first){var m=(first.textContent||'').trim().match(/(\d+)\s*(AM|PM)/i);if(m){startHour=(+m[1])%12;if(m[2].toUpperCase()==='PM')startHour+=12;}}root.querySelectorAll('.vx95-runway-event[data-start-at]').forEach(function(el){var sd=new Date(el.getAttribute('data-start-at')),ed=new Date(el.getAttribute('data-end-at'));if(isNaN(sd))return;if(isNaN(ed)||ed<=sd)ed=new Date(sd.getTime()+3600000);var duration=Math.max(5,(ed-sd)/60000),top=Math.max(0,(sd.getHours()+sd.getMinutes()/60-startHour)*60);el.style.setProperty('--vx-runway-top',top+'px');el.style.setProperty('--vx-runway-height',duration+'px');el.style.setProperty('top',top+'px','important');el.style.setProperty('height',duration+'px','important');el.style.setProperty('min-height',duration+'px','important');el.style.setProperty('max-height',duration+'px','important');el.setAttribute('data-geometry-verified','16.11.40');el.setAttribute('data-duration-minutes',String(Math.round(duration)));});}
var q=0;function run(){if(q)return;q=1;requestAnimationFrame(function(){q=0;apply();});}
document.readyState==='loading'?document.addEventListener('DOMContentLoaded',run,{once:true}):run();new MutationObserver(run).observe(document.documentElement,{childList:true,subtree:true});window.addEventListener('resize',run,{passive:true});})();
;/* END cavyre-calendar-geometry-runtime-16.11.40.js */
...
;/* cavyre-task-crud-authority-16.11.42.js removed 2026-09-23: duplicate Add Task wiring — it and cavyre-task-quick-create-authority-16.12.75.js (loaded later on this page) each ran their own full-document MutationObserver that reassigned the same .v148-btn.gold Add Task button onclick on every DOM mutation anywhere in the app, fighting each other for control of the button and adding constant main-thread churn (a likely cause of the button needing repeated clicks, and of it feeling unresponsive/broken on iPad). 16.12.76 is the sole task-CRUD authority now; it aliases window.CAVYRE_TASK_CRUD_161142 for any legacy caller that still reads that global directly. */
