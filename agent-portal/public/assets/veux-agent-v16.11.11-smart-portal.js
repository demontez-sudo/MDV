...
h+='<section class="vx17-panel vx17-priority-panel"><header><h3>Priority Stream</h3><small>Why each signal matters</small></header><div class="vx17-priority">'+sig+'</div></section></div><div class="vx17-smart-grid">'+smartCards()+'</div></div>';el.innerHTML=h;bind(el)}h+='<div class="vx17-market-grid"><div class="vx17-market"><small>New York</small><b>'+clock('America/New_York')+'</b><span>'+marketCount(p.cal,'New York')+' active events · live agency time</span></div><div class="vx17-market"><small>Paris</small><b>'+clock('Europe/Paris')+'</b><span>'+marketCount(p.cal,'Paris')+' active events · live agency time</span></div><div class="vx17-market"><small>Roster Ready</small><b>'+readyPct+'%</b><span>'+p.ready+' ready now · '+Math.max(0,total-p.ready)+' updates</span></div></div>';
