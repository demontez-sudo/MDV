(function(){
'use strict';
if(window.__CAVYRE_VERA_LOGO_AUTHORITY_161406__)return;
window.__CAVYRE_VERA_LOGO_AUTHORITY_161406__=true;
...
function mark(cls){var s=document.createElement('span');s.className='cvy-vera-logo-161406'+(cls?' '+cls:'');s.innerHTML=SVG;return s;}
function set(el,cls){if(!el)return;if(el.querySelector(':scope > .cvy-vera-logo-161406'))return;el.querySelectorAll(':scope > img,:scope > .vera-mark,:scope > .vera-mark-img,:scope > .vera-avatar-img,:scope > .vx20-vera-wave-mark,:scope > i').forEach(function(n){n.remove();});el.insertBefore(mark(cls),el.firstChild);}
function apply(){
...
window.CAVYRE_VERA_LOGO={version:'16.14.06',refresh:apply};
})();
