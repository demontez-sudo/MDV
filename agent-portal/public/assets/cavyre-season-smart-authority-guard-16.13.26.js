/* CAVYRE 16.13.26 — Direct Season Authority Guard */
(function(){'use strict';
if(window.__CAVYRE_SEASON_GUARD_161326__)return;window.__CAVYRE_SEASON_GUARD_161326__=1;
function repair(){var A=window.CAVYRE_SMART_SEASON_161326;if(!A||typeof A.takeover!=='function')return;var p=String(window._currentPage||location.hash.replace(/^#/,'')||'').toLowerCase(),h=document.getElementById('p-seasonmanagement')||document.getElementById('p-season'),v=!!(h&&(h.classList.contains('on')||h.offsetParent!==null));if(p!=='season'&&p!=='seasonmanagement'&&!v)return;A.takeover();}
