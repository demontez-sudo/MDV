...
var VERSION='16.11.48', relationshipRenderer=null, relationshipBound=false;
function stamp(){
...
function refreshRelationships(){
  ...
  if(window.CavyreRelationships&&typeof window.CavyreRelationships.refresh==='function'){
    return window.CavyreRelationships.refresh().then(function(){stamp();return true;}).catch(function(e){console.error('[CAVYRE 16.11.48 Relationships]',e);return false;});
  }
