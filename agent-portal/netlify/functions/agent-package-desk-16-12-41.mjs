...
async function replacePackageContent(admin,organization,pkg,body,user){
  ...
  const assetTypes=Array.isArray(body.asset_types)?[...new Set(body.asset_types.map(String).filter(Boolean))]:Array.isArray(currentMeta.asset_types)?currentMeta.asset_types:['headshots','digitals','polaroids','editorial','runway','video','comp_card'];
