...
export const handler=async(event)=>{
  ...
  try{
    ...
    const [packagesRaw,openFeedbackRaw,signalsRaw]=await Promise.all([
    ...
    const packages=packagesRaw.map(x=>({...x,companies:x.company_id?coMap.get(x.company_id)||null:null}));
